...
from wx.lib.agw.gradientbutton import GradientButton as GB
from wx.lib.agw.aquabutton import AquaButton as AB
...
class Gui_linux(wx.Frame):
    ...
    def on_run_button(self, event):
        ...
        if self.animation_constraint:
            error_pop_up(
                'End animation before trying to execute another action')
            return
